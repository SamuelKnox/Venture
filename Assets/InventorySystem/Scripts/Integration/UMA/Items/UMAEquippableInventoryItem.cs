    ...
    public class UMAEquippableInventoryItem : EquippableInventoryItem
    {
        ...
        protected UMAData umaData
        {
            get
            {
                if (_umaData == null)
                {
                    _umaData = InventoryPlayerManager.instance.currentPlayer.GetComponent<UMAData>();
                }
        ...
        protected OverlayLibraryBase overlayLibrary
        {
            get
            {
                if (_overlayLibrary == null)
                    _overlayLibrary = InventoryPlayerManager.instance.currentPlayer.GetComponent<UMADynamicAvatar>().context.overlayLibrary;
        ...
        protected SlotLibraryBase slotLibrary
        {
            get
            {
                if (_slotLibrary == null)
                    _slotLibrary = InventoryPlayerManager.instance.currentPlayer.GetComponent<UMADynamicAvatar>().context.slotLibrary;
