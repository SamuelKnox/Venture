...
namespace Devdog.InventorySystem
{
    ...
    public partial class InventoryPlayerRangeHelper : MonoBehaviour
    {
        ...
        private int? _bestTriggererInstanceID;
        ...
        public ObjectTriggererBase bestTriggerer
        {
            ...
            protected set
            {
                ...
                var idBefore = _bestTriggererInstanceID;
                _bestTriggerer = value;

                _bestTriggererInstanceID = null;
                if (value != null)
                    _bestTriggererInstanceID = value.gameObject.GetInstanceID();

                if (idBefore != _bestTriggererInstanceID)
                {
                    // New best triggerer
        ...
        public virtual ObjectTriggererBase GetBestTriggererInRange()
        {
            ...
            triggerersInRange.RemoveAll(o => o == null || o.enabled == false);
