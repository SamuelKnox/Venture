...
{
    [HelpURL("http://devdog.nl/documentation/inventory/")]
...
//        }
        ...
        public InventoryAudioClip swapItemAudioClip;
        public InventoryAudioClip sortAudioClip;
        public InventoryAudioClip onAddItemAudioClip; // When an item is added to the inventory
        ...
        public override void Awake()
        {
            ...
            if(sortButton != null)
            {
                sortButton.onClick.AddListener(() =>
                {
                    ...
                    InventoryAudioManager.AudioPlayOneShot(sortAudioClip);
                });
            }
        }
        ...
        public override void Start()
        {
            ...
            {
                InventoryAudioManager.AudioPlayOneShot(onAddItemAudioClip);
            };

            OnSwappedItems += (ItemCollectionBase fromCollection, uint fromSlot, ItemCollectionBase toCollection, uint toSlot) =>
            {
                InventoryAudioManager.AudioPlayOneShot(swapItemAudioClip);
            };
