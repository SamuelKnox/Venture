...
namespace Devdog.InventorySystem
{
    ...
    public partial class CharacterUI : ItemCollectionBase, ICollectionPriority, IInventoryDragAccepter
    {
        ...
        [Header("UI Prefabs")]
        public InventoryCharacterStatRowUI statusRowPrefab;
        public InventoryCharacterStatCategoryUI statusCategoryPrefab;
        ...
        [NonSerialized]
        protected InventoryPool<InventoryCharacterStatRowUI> rowsPool;

        [NonSerialized]
        protected InventoryPool<InventoryCharacterStatCategoryUI> categoryPool;
        ...
        public override void Awake()
        {
            ...
            if (statusRowPrefab != null)
                rowsPool = new InventoryPool<InventoryCharacterStatRowUI>(statusRowPrefab, 32);

            if (statusCategoryPrefab != null)
                categoryPool = new InventoryPool<InventoryCharacterStatCategoryUI>(statusCategoryPrefab, 8);
        ...
        public virtual void RepaintAllStats()
        {
            ...
            foreach (var stat in stats)
            {
                ...
                InventoryCharacterStatCategoryUI cat = null;
                if (statusCategoryPrefab != null)
                {
        ...
        public override void NotifyItemAdded(IEnumerable<InventoryItemBase> items, uint amount, bool cameFromCollection)
        {
            ...
            foreach (var item in items)
            {
                ...
                ((EquippableInventoryItem)item).NotifyItemEquipped(equipSlotFields[item.index], amount);
            }
        }
        ...
        public override void NotifyItemRemoved(InventoryItemBase item, uint itemID, uint slot, uint amount)
        {
            ...
            ((EquippableInventoryItem)item).NotifyItemUnEquipped(this, amount);
