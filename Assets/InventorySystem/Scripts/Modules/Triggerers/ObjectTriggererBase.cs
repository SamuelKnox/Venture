...
namespace Devdog.InventorySystem
{
    ...
    [HelpURL("http://devdog.nl/documentation/triggerers/")]
    public abstract class ObjectTriggererBase : MonoBehaviour
    {
        ...
        protected virtual void NotifyTriggererUsed(InventoryPlayer usedByPlayer)
        {
            
        }

        protected virtual void NotifyTriggererUnUsed(InventoryPlayer usedByPlayer)
        {
        ...
        public virtual bool AreKeysDown()
        {
            var overrider = GetComponent<IObjectTriggerInputOverrider>();
            if (overrider != null)
            {
                return overrider.AreKeysDown(this);
            }

            return Input.GetKeyDown(triggerKeyCode) && triggerKeyCode != KeyCode.None;
        }
    }
}
