...
namespace Devdog.InventorySystem.Editors
{
    ...
    public class ObjectTriggererEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var t = (ObjectTriggerer) target;

            var o = t.gameObject.GetComponent(typeof (IObjectTriggerUser));
            if (o != null)
            {
            ...
            var inputOverrider = t.gameObject.GetComponent<IObjectTriggerInputOverrider>();
            if (inputOverrider != null)
            {
                EditorGUILayout.HelpBox("Input is overwritten by " + inputOverrider.GetType().Name, MessageType.Info);
            }
