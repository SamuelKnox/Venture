...
namespace Devdog.InventorySystem
{
    ...
    public partial class ObjectTriggererItem : ObjectTriggererBase
    {
        ...
        {
            if (InventoryInputManager.instance.objectTriggererItemInputOverrider != null)
            {
                return InventoryInputManager.instance.objectTriggererItemInputOverrider.AreKeysDown(this);
            }

            return base.AreKeysDown();
        }
    }
}