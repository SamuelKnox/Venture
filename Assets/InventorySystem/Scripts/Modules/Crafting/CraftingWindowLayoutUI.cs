...
namespace Devdog.InventorySystem
{
    ...
    public partial class CraftingWindowLayoutUI : CraftingWindowBase
    {
        ...
        public void RepaintLayout(InventoryCraftingCategory category)
        {
            ...
            {
                SetCraftingBlueprint(null);
            }

            RepaintMainItemsCollection();
        }

        public virtual void ValidateReferences(InventoryCraftingCategory category)
        {
        ...
        public virtual InventoryCraftingBlueprint GetBlueprintFromCurrentLayout(ItemCollectionBase collection, InventoryCraftingCategory category)
        {
