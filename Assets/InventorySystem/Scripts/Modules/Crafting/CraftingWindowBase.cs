...
namespace Devdog.InventorySystem
{
    ...
    {
        [SerializeField]
        private uint _startCraftingCategoryID;
        public InventoryCraftingCategory startCraftingCategory
        {
            get
            {
                return ItemManager.database.craftingCategories.FirstOrDefault(o => o.ID == _startCraftingCategoryID);
            }
        }

        [SerializeField]
        public bool _cancelCraftingOnWindowClose = true;
        ...
        public UIShowValueModel blueprintCraftingProgress = new UIShowValueModel();
//        public UnityEngine.UI.Slider blueprintCraftProgressSlider;
        ...
        protected virtual void InstanceOnPlayerChanged(InventoryPlayer oldPlayer, InventoryPlayer newPlayer)
        {
            if (oldPlayer != null)
            {
        ...
        public virtual void CraftCurrentlySelectedBlueprint(int amount)
        {
            ...
            progressContainer.AddBlueprintToCraftingQueue(InventoryPlayerManager.instance.currentPlayer, currentCategory, currentBlueprint, amount, storeRewardItemsInCollection, removeItemsFromCollection);
        }
        ...
        public virtual void UseWithTrigger(InventoryCraftingCategory category, CraftingProgressContainer progressContainer, ICraftingActionValidator validator, ItemCollectionBase removeItemsFromCollection, ItemCollectionBase storeRewardItemsInCollection)
        {
        ...
        public virtual void SetCraftingBlueprint(InventoryCraftingBlueprint blueprint)
        {
            ...
            else
            {
                ...
                if (blueprintCraftCost != null)
                    blueprintCraftCost.Repaint(new InventoryCurrencyLookup());
            }
        ...
        public virtual InventoryCraftingBlueprint[] GetBlueprints(InventoryCraftingCategory category)
        {
        ...
        {
            return CanCraftBlueprint(InventoryPlayerManager.instance.currentPlayer, craftInfo);
        }
        ...
        public virtual bool CanCraftBlueprint(InventoryPlayer player, CraftingProgressContainer.CraftInfo craftInfo)
        {
            ...
            {
                foreach (var propLookup in craftInfo.blueprint.usageRequirementProperties)
                {
                    if (propLookup.CanUse(player) == false)
                    {
                        InventoryManager.langDatabase.craftingCannotPropertyNotValid.Show(craftInfo.blueprint.name, craftInfo.blueprint.description, propLookup.property.name);
                        return false;
                    }
                }
            }
        ...
        protected virtual bool CanAddItemsRewardItems(CraftingProgressContainer.CraftInfo craftInfo)
        {
            if (craftInfo.storeItemsInCollection != null)
            {
                ...
                var l = new List<InventoryItemAmountRow>();
        ...
        public virtual void GiveCraftReward(CraftingProgressContainer.CraftInfo craftInfo)
        {
            ...
            {
                var i = item as Devdog.InventorySystem.Integration.UFPS.UFPSInventoryItemBase;
                if (i != null)
                {
                    Devdog.InventorySystem.Integration.UFPS.Multiplayer.InventoryMPUFPSPickupManager.instance.RegisterPickup(i);
                }
            }
#endif
        ...
        protected virtual void SetBlueprintResults(InventoryCraftingBlueprint blueprint)
        {
            if (blueprintItemResultContainer != null)
            {
                if (blueprint != null)
                {
                    ...
                    {
                        var wrapper = Instantiate<InventoryUIItemWrapperBase>(blueprintItemResultPrefab);
