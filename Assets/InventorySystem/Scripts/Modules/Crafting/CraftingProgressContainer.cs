...
namespace Devdog.InventorySystem
{
    public partial class CraftingProgressContainer
    {
        public class CraftInfo
        {
            ...
            public InventoryCraftingBlueprint blueprint { get; set; }
            public InventoryCraftingCategory category { get; set; }
            ...
            public CraftInfo(IEnumerator activeCraft, ICraftingActionValidator validator, AudioSource audioSource, InventoryCraftingCategory category, InventoryCraftingBlueprint blueprint)
            {
            ...
            public void PlayAudioSource(InventoryAudioClip clip)
            {
                if(clip != null)
                {
                    if (audioSource == null)
...
//        public ItemCollectionBase rewardsCollection { get; set; }
        ...
        {
            InventoryAudioClip clip = craftInfo.category.craftingAudioClip;
        ...
        protected virtual void NotifyCraftSuccess(CraftInfo craftInfo)
        {
            ...
            InventoryAudioClip clip = craftInfo.category.successAudioClip;
            if (craftInfo.blueprint.overrideCategoryAudioClips)
            {
        ...
        protected virtual void NotifyCraftFailed(CraftInfo craftInfo)
        {
            ...
            InventoryAudioClip clip = craftInfo.category.failedAudioClip;
            if (craftInfo.blueprint.overrideCategoryAudioClips)
            {
        ...
        protected virtual void NotifyCraftCanceled(CraftInfo craftInfo, float progress)
        {
            ...
            InventoryAudioClip clip = craftInfo.category.canceledAudioClip;
            if (craftInfo.blueprint.overrideCategoryAudioClips)
            {
        ...
        /// </summary>
        public virtual bool AddBlueprintToCraftingQueue(InventoryPlayer player, InventoryCraftingCategory category, InventoryCraftingBlueprint blueprint, int amount, ItemCollectionBase storeRewardsCollection, ItemCollectionBase removeItemsFromCollection)
        {
