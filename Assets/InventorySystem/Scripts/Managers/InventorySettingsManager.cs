...
namespace Devdog.InventorySystem
{
    ...
    public partial class InventorySettingsManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// The version number of Inventory Pro.
        /// </summary>
        ...
        [InventoryEditorCategory("Layers")]
        ...
        public InventoryItemRarity showConfirmationDialogMinRarity
        {
            get
            {
                ...
                return ItemManager.database.itemRarities[_showConfirmationDialogMinRarity];
            }
        }
        ...
        /// <summary>
        /// When true an exception will be thrown if an assertion fails. When disabled only a message will be logged.
        /// </summary>
        [InventoryEditorCategory("Editor & Testing")]
        [Header("Testing")]
...
//                if (_instance == null)
//                {
//                    throw new ManagerNotFoundException("InventorySettingsManager");
//                }
        ...
        public void Awake()
        {
            ...
            noActionCursor.Enable();
            Assert.raiseExceptions = useExceptionsForAssertions;
        }
    }
}