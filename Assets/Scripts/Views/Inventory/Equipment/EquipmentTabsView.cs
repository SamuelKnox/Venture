...
//    {
//        return tabs[currentIndex].GetItemType();
//    }
...
//        {
//            var equipmentTabInstance = Instantiate(tabs[i]);
...
//                return;
//            }
//            equipmentTabTransform.SetParent(tabPanel);
...
//            return false;
//        }
//        var runeTypes = browserView.GetActiveEquipmentForRunes().GetRuneTypes();
//        int skippedRunes = 0;
...
//                return false;
//            }
//            runeTabTransform.SetParent(tabPanel);
