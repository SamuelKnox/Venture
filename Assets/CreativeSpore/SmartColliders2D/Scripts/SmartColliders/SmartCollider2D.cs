...
namespace CreativeSpore.SmartColliders
{
    ...
    public class SmartCollider2D : MonoBehaviour
    {
        ...
        protected RaycastHit _GetClosestHitInfo(Vector3 origin, Vector3 direction, float distance, int layerMask)
        {
        ...
        protected RaycastHit2D _GetClosestHitInfo2D(Vector3 origin, Vector3 direction, float distance, int layerMask)
        {
