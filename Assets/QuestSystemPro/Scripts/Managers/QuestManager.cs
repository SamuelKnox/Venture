...
namespace Devdog.QuestSystemPro
{
    public partial class QuestManager : MonoBehaviour
    {
        ...
        [NonSerialized]
        public QuestSystemPlayer currentPlayer;
        ...
        protected virtual void Awake()
        {
            ...
            localIdentifier = new LocalIdentifier(GetComponent<NetworkIdentity>());
        ...
        public virtual void NotifyQuestStatusChanged(Quest quest)
        {
            Assert.IsNotNull(quest.localIdentifier, "Quest local identifier is null. Quest (most likely) doesn't exist in current database.");
            switch (quest.status)
            {
        ...
        public virtual void NotifyAchievementStatusChanged(Achievement achievement)
        {
            if (OnAchievementStatusChanged != null)
            {
                OnAchievementStatusChanged(achievement);
            }
        }
