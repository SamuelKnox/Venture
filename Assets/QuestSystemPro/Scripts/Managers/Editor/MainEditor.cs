...
namespace Devdog.QuestSystemPro.Editors
{
    ...
    public class MainEditor : EditorWindow
    {
        ...
        public static MainEditor window
        {
            ...
            {
                if(_window == null)
                    _window = GetWindow<MainEditor>(false, "Main manager", false);
        ...
        {
            _window = GetWindow<MainEditor>(false, "Main manager", true);
        }
...
//            _databasesInProject = AssetDatabase.FindAssets("t:" + typeof(InventoryItemDatabase).Name);
            ...
            SetupWizardEditor.CheckScene();
            SetupWizardEditor.OnIssuesUpdated += UpdateMiniToolbar;
        ...
        static internal void UpdateMiniToolbar(List<SetupWizardEditor.SetupIssue> issues)
        {
            window.Repaint();
        }
        ...
        public virtual void CreateEditors()
        {
            ...
            itemEditor.childEditors.Add(new QuestSystemProQuestsEditor("Quest", "Quests", this));
            itemEditor.childEditors.Add(new QuestSystemProAchievementsEditor("Achievement", "Achievements", this));
        ...
        internal static void DrawMiniToolbar(List<SetupWizardEditor.SetupIssue> issues)
        {
...
//            EditorPrefs.DeleteKey("InventorySystem_ItemPrefabPath");
            ...
            {
                EditorUtility.ErrorIfEmpty(EditorPrefs.GetString(SettingsEditor.PrefabSaveKey) == string.Empty, "Prefab folder is not set, items cannot be saved.");
            ...
            DrawMiniToolbar(SetupWizardEditor.setupIssues);
        }
    }
}