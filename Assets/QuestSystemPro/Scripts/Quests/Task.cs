...
namespace Devdog.QuestSystemPro
{
    ...
    public partial class Task
    {
        ...
        public string statusMessage = "Captured {0}/{2} items";
        ...
        // TODO: Save / loading in seperate serialization model.
        [NonSerialized]
        ...
        // TODO: Save / loading in seperate serialization model.
        [fsIgnore]
        public bool gaveRewards { get; protected set; }
...
//        [Obsolete("Use other constructors instead.")]
        ...
        public virtual void Activate()
        {
            ...
            {
                QuestLogger.Log("Trying to activate completed task. If you wish to start it again call SetProgress instead.");
            }
        }
        ...
        public virtual bool Complete(bool forceComplete = false)
        {
            ...
            QuestLogger.LogVerbose("Completed task: \"" + key + "\" on " + owner.GetType().Name + " \"" + owner.name + "\"");
            return isCompleted;
        }
        ...
        public virtual void Fail()
        {
            ...
            {
                QuestLogger.Log("Trying to fail completed task. If you wish to start it again call SetProgress instead.");
            }
        }
        ...
        {
            return string.Format(statusMessage, progress, progressNormalized, progressCap);
        }
    }
}