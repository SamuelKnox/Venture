...
namespace Devdog.QuestSystemPro
{
    ...
    {
        public new delegate void StatusChanged(Achievement achievement);
        ...
        protected override void DoNotifyQuestStatusChanged()
        {
            QuestManager.instance.NotifyAchievementStatusChanged(this);
        ...
        /// </summary>
        protected override bool CanSetTaskProgress(string key, float value)
        {
            return true;
        }
        ...
        public override bool SetTaskProgress(string key, float value)
        {
            ...
            {
                QuestLogger.LogVerbose("Setting achievement task progress, but achievement was not activated yet. Auto. activating achievement...");
                Activate();
            }
