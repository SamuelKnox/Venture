...
namespace Devdog.QuestSystemPro.Dialogue
{
    ...
    public abstract class NodeBase
    {
        ...
        [HideTypePicker]
        public AudioClipInfo audioClip; // TODO: Probably use a custom object for more flexiblity (pitch, volume, reverb)
        [HideTypePicker]
        public AnimationClip animationClip; // TODO: Probably use a custom object for more flexiblity
...
//                        return NodeStyle.Blue;
        ...
        {
            QuestLogger.LogWarning("Couldn't complete node with message: " + message.message);
        }

        public void Error(MultiLangString message, bool abort)
        {
            QuestLogger.LogError("Error on node with message: " + message.message);
        }
