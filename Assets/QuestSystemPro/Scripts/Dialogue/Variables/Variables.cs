...
namespace Devdog.QuestSystemPro.Dialogue
{
    public static class Variables
    {
        ...
        {
            QuestLogger.LogVerbose("Getting variable with GUID: " + g + " Looking through " + variableContainers.Count + " containers.");
            ...
            QuestLogger.LogWarning("Trying to get variable with GUID " + g + " - Not found.");
            return null;
        }
